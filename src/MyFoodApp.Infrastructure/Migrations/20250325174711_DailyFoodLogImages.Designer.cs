...
namespace MyFoodApp.Infrastructure.Migrations
{
    ...
    [Migration("20250325174711_DailyFoodLogImages")]
    partial class DailyFoodLogImages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFoodApp.Domain.Entities.DailyFoodLog", b =>
                {
                    ...
                    b.ToTable("DailyFoodLog");
                });

            modelBuilder.Entity("MyFoodApp.Domain.Entities.DailyFoodLogRecipe", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyFoodApp.Domain.Entities.RecipePhoto", b =>
                {
                    b.Property<int>("RecipePhotoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RecipePhotoId"));
                    ...
                    b.HasKey("RecipePhotoId");

                    b.HasIndex("RecipeId");

                    b.ToTable("RecipePhoto");
                });
            ...
            modelBuilder.Entity("MyFoodApp.Domain.Entities.DailyFoodLog", b =>
                {
                    b.HasOne("MyFoodApp.Domain.Entities.Authentication.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyFoodApp.Domain.Entities.DailyFoodLogRecipe", b =>
                {
                    b.HasOne("MyFoodApp.Domain.Entities.DailyFoodLog", "DailyFoodLog")
                        .WithMany("LoggedRecipes")
                        .HasForeignKey("LogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyFoodApp.Domain.Entities.Recipe", "Recipe")
                        .WithMany("DailyFoodLogs")
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DailyFoodLog");
